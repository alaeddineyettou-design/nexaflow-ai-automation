...
const DatabaseWithRestApi = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[350px] w-full max-w-[500px] flex-col items-center database-component",
        className
      )}
    >
      {/* SVG Paths  */}
      <svg
        className="h-full sm:w-full text-muted-foreground"
        width="100%"
        height="100%"
        viewBox="0 0 200 100"
        ...
        <g stroke="currentColor" fill="none" strokeWidth="0.4">
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <DatabaseIcon x="17" y="8"></DatabaseIcon>
            <text
              x="32"
              y="11.5"
              fill="#ffffff"
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <DatabaseIcon x="63" y="8"></DatabaseIcon>
            <text
              x="78"
              y="11.5"
              fill="#ffffff"
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <DatabaseIcon x="111" y="8"></DatabaseIcon>
            <text
              x="126"
              y="11.5"
              fill="#ffffff"
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <DatabaseIcon x="153" y="8"></DatabaseIcon>
            <text
              x="171"
              y="11.5"
              fill="#ffffff"
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          {/* Badges */}
          <div className="absolute bottom-8 left-12 z-10 h-7 rounded-full bg-[#101112] px-4 text-xs border flex items-center gap-2 text-white">
            <HeartHandshakeIcon className="size-4 text-white" />
            <span className="font-medium tracking-wide">{buttonTexts?.first || "LegionDev"}</span>
          </div>
          <div className="absolute right-16 z-10 hidden h-7 rounded-full bg-[#101112] px-4 text-xs sm:flex border items-center gap-2 text-white">
            <Folder className="size-4 text-white" />
            <span className="font-medium tracking-wide">{buttonTexts?.second || "v2_updates"}</span>
          </div>
          {/* Circles */}
          <motion.div
