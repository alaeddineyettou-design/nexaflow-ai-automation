...
export default function RadialOrbitalTimeline({
  ...
  // Removed per request: entire black background container
  /*
  return (
    <div
    ...
    >
      {/* Removed per request: Ethereal Shadow Background *\/}
      {/* Removed per request: orbit wrapper container *\/}
      {false && (
                  ...
                  <div
                    ...
                    ${
                      isExpanded
                        ...
                        : index === 1 ? "bg-gradient-to-br from-blue-500 to-cyan-500 text-white"
                        : index === 2 ? "bg-gradient-to-br from-green-500 to-emerald-500 text-white"
                        : index === 3 ? "bg-gradient-to-br from-orange-500 to-red-500 text-white"
