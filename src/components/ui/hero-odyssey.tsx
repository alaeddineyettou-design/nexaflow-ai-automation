      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
        ...
        >
          <motion.div variants={itemVariants}>
            <FeatureItem name="Make.com" value="Visual Automation" position="left-0 sm:left-10 top-40" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="n8n" value="Open Source" position="left-1/4 top-24" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="Zapier" value="App Integration" position="right-1/4 top-24" />
          </motion.div>
          <motion.div variants={itemVariants}>
            <FeatureItem name="AI-Powered" value="Smart Workflows" position="right-0 sm:right-10 top-40" />
          </motion.div>
        </motion.div>
        ...
        >            
          ...
          {/* Button: "Join us for automation excellence" */}
          <motion.button
          ...
          >
            <span>Join us for automation excellence</span>
          ...
          >
            Experience next-generation business automation with interactive lightning effects and intelligent workflows that adapt to your needs.
          </motion.p>
