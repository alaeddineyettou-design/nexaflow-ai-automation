...
export default function CombinedFeaturedSection() {
  const featuredCasestudy = {
    logo: '/nexaflow-logo.png',
    company: 'NexaFlow',
    tags: 'AI Automation Expert',
    title: 'How we automated 90% of workflows',
    subtitle: 'for businesses worldwide using Make.com, n8n, and advanced AI integration solutions',
  }
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-0">
        ...
        <div className="relative rounded-none overflow-hidden bg-muted border border-gray-200 dark:border-gray-800 p-4">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
            ...
            NexaFlow Global Reach
          </div>
          <h3 className="text-xl font-normal text-gray-900 dark:text-white">
            Serving clients across Germany & globally.{" "}
            <span className="text-gray-500 dark:text-gray-400">Professional automation solutions worldwide.</span>
          </h3>
        ...
        <div className="flex flex-col justify-between gap-4 p-6 rounded-none border border-gray-200 dark:border-gray-800 bg-card">
          ...
          <div className="flex justify-center items-center w-full">
            <AIAutomationFeaturedMessageCard />
          </div>
        </div>
        ...
        <div className="rounded-none border border-gray-200 dark:border-gray-800 bg-muted p-6 space-y-4">
          ...
          <h3 className="text-xl font-normal text-gray-900 dark:text-white">
            Real-time performance tracking for automated workflows.{" "}
            <span className="text-gray-500 dark:text-gray-400">Monitor efficiency gains instantly.</span>
          </h3>
          <MonitoringChart />
        </div>
        ...
        <div className="grid sm:grid-cols-2 rounded-none bg-card">
          <FeatureCard
            ...
            subtitle="Expert Integration"
            description="Professional Make.com workflow setup and optimization for maximum efficiency."
          />
          <FeatureCard
            icon={<Flower className="w-4 h-4" />}
            title="n8n Custom Workflows"
            subtitle="Tailored Solutions"
            description="Custom n8n automation designed specifically for your business requirements."
          />
        </div>
      </div>
    </section>
...
// Chart Component
const chartData = [
  { month: 'May', automation: 56, efficiency: 224 },
  { month: 'June', automation: 90, efficiency: 300 },
  { month: 'July', automation: 126, efficiency: 352 },
  { month: 'Aug', automation: 205, efficiency: 410 },
  { month: 'Sep', automation: 280, efficiency: 526 },
  { month: 'Oct', automation: 400, efficiency: 800 },
]
      ...
      <AreaChart data={chartData}>
        <defs>
          <linearGradient id="fillAutomation" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--color-automation)" stopOpacity={0.8} />
            <stop offset="55%" stopColor="var(--color-automation)" stopOpacity={0.1} />
          </linearGradient>
        ...
        <Area strokeWidth={2} dataKey="efficiency" type="monotone" fill="url(#fillEfficiency)" stroke="var(--color-efficiency)" />
        <Area strokeWidth={2} dataKey="automation" type="monotone" fill="url(#fillAutomation)" stroke="var(--color-automation)" />
      </AreaChart>
    </ChartContainer>
  )
}
...
const messages: Message[] = [
  {
    ...
    time: "1m ago",
    content: "New automation workflow deployed successfully.",
    color: "from-blue-400 to-indigo-500",
  },
  {
    title: "Client Success",
    time: "3m ago",
    content: "Automation saved 40+ hours this week for client.",
    color: "from-green-500 to-emerald-500",
  },
  {
    title: "Make.com Integration",
    time: "6m ago",
    content: "Advanced workflow integration completed.",
    color: "from-purple-400 to-pink-400",
  },
  {
    title: "n8n Automation",
    time: "10m ago",
    content: "Custom node configuration optimized.",
    color: "from-sky-400 to-blue-700",
  },
  {
    title: "AI Enhancement",
    time: "12m ago",
    content: "Machine learning model integrated into workflow.",
    color: "from-orange-300 to-red-400",
  },
  {
    title: "Performance Report",
    time: "15m ago",
    content: "Weekly automation metrics show 90% efficiency gain.",
    color: "from-emerald-400 to-cyan-500",
  },
]

const AIAutomationFeaturedMessageCard = () => {
  return (
    <div className="w-full max-w-sm h-[280px] bg-white dark:bg-gray-900 p-2 overflow-hidden font-sans relative">
      ...
      <div className="absolute bottom-2 left-2 right-2 text-center">
        <div className="text-xs text-gray-500 dark:text-gray-400 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded px-2 py-1">
