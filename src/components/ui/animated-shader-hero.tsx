        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          ...
          <div className="mb-8 animate-fade-in-down">
            <div className="flex justify-center">
              <div className="flex items-center space-x-4 px-6 py-3 nexaflow-overlay rounded-full nexaflow-light-sweep relative overflow-hidden">
                <span className="text-2xl font-bold nexaflow-text-gradient nexaflow-text-crisp tracking-tight">
                  NEXAFLOW
                </span>
              </div>
            </div>
          ...
          {/* Main Heading with GooeyText Animation */}
          <div className="space-y-6">
            <div className="animate-fade-in-up animation-delay-200">
              <div className="flex flex-col items-center justify-center text-center space-y-2">
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-amber-300 bg-clip-text text-transparent">
                  {headline.line1}
                </h1>
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-pink-400 bg-clip-text text-transparent">
                  {headline.line2}
                </h1>
              </div>
            </div>
