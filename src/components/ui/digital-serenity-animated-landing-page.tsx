        ...
        <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-6 py-10 sm:px-8 sm:py-12 md:px-16 md:py-20">
          <div className="text-center">
            <h2 className="text-xs sm:text-sm font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80">
              <span className="word-animate" data-delay="0">Automation</span>
              <span className="word-animate" data-delay="300">perfected.</span>
            </h2>
          ...
          <div className="text-center max-w-5xl mx-auto relative">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight leading-tight tracking-tight text-slate-50 text-decoration-animate">
              <div className="mb-4 md:mb-6">
                <span className="word-animate" data-delay="700">Transform</span>
                <span className="word-animate" data-delay="850">your</span>
                <span className="word-animate" data-delay="1000">business,</span>
              </div>
              ...
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-thin text-slate-300 leading-relaxed tracking-wide">
                ...
                <span className="word-animate" data-delay="1550">efficiency</span>
                <span className="word-animate" data-delay="1700">meets</span>
                <span className="word-animate" data-delay="1850">innovation</span>
                <span className="word-animate" data-delay="2000">and</span>
                <span className="word-animate" data-delay="2150">workflows</span>
                <span className="word-animate" data-delay="2300">become</span>
                <span className="word-animate" data-delay="2450">effortless</span>
                <span className="word-animate" data-delay="2600">poetry.</span>
              </div>
            </h1>
          ...
          <div className="text-center">
            ...
            <h2 className="text-xs sm:text-sm font-mono font-light text-slate-300 uppercase tracking-[0.2em] opacity-80">
              <span className="word-animate" data-delay="3000">Automate,</span>
              <span className="word-animate" data-delay="3200">optimize,</span>
              <span className="word-animate" data-delay="3400">scale</span>
              <span className="word-animate" data-delay="3550">infinitely.</span>
            </h2>
